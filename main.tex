...
\name{Barbosa}{George C. G.}
% \position{Software Architect{\enskip\cdotp\enskip}Security Expert}
% \address{YOUR ADDRESS}

\mobile{+1 323 673 1078}
\email{gcgbarbosa@gmail.com}
%\dateofbirth{January 1st, 1970}
\homepage{gcgbarbosa.com}
\github{github.com/gcgbarbosa}
\linkedin{linkedin.com/in/gcgbarbosa}
% \gitlab{gitlab-id}
...
% \medium{madium-id}
% \kaggle{kaggle-id}
% \googlescholar{2_H8atkAAAAJ}{Google Scholar}
%% \firstname and \lastname will be used
% \googlescholar{googlescholar-id}{}
% \extrainfo{extra information}

\quote{``Of all things, I liked books best. --Nikola Tesla"}
